...
| 状態 | 条件 | 表示 |
|------|------|------|
| 🟢 OK | 8:50以前にチェック完了 | `🟢 8:45` |
| 🟡 Warning | 8:50〜9:50の間にチェック完了 | `🟡 9:15 (遅延)` |
| 🔴 Alert | 9:50以降 or 未実施 | `🔴 未実施` |

#### 午後チェック (14:00〜14:50)
| 状態 | 条件 | 表示 |
|------|------|------|
| 🟢 OK | 14:50以前にチェック完了 | `🟢 14:40` |
| 🟡 Warning | 14:50〜15:50の間にチェック完了 | `🟡 15:20 (遅延)` |
| 🔴 Alert | 15:50以降 or 未実施 | `🔴 未実施` |
...
| ファイル | 変更内容 |
|---------|---------|
| `backend/app/api/dashboard.py` | 新エンドポイント追加、既存を置き換え |
| `backend/app/core/config.py` | アラート設定追加 |
| `backend/app/schemas.py` | 新レスポンススキーマ追加 |
| `frontend/app/dashboard/page.tsx` | シンプルダッシュボードに置き換え |
| `frontend/lib/types.ts` | 型定義追加 |
| `frontend/lib/api.ts` | API関数追加 |
| `frontend/app/admin/page.tsx` | 主要チェックポイント管理を削除 |
